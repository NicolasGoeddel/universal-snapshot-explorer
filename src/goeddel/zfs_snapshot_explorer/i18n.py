...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "snapshot.none": "None",
        "index.title": "ZFS Snapshot Explorer - Roots",
        ...
        "index.header.root_path": "ZFS Root Path",
    ...
    "de": {
        ...
        "badge.missing": "Nicht vorhanden",
        "badge.unmounted": "Nicht gemountet",
        "badge.live": "Live (Aktuell)",
        "table.name": "Name",
        "table.size": "Größe",
        "table.type": "Typ",
        ...
        "action.show_folder_details": "Ordner-Details anzeigen",
        "action.open_target": "Zum Ziel springen",
        "action.changed_from": "Geändert von",
        "action.open_explorer": "Im Explorer öffnen",
        ...
        "index.header.name": "Name",
        "index.header.root_path": "ZFS Root-Pfad",
